...
class SlurmJobSubmitter:
    ...
    def __init__(self, workspace_path: str = "/home/s3665534/VERONA/examples/scripts"):
...
def main():
    ...
    architectures =  ["TL1_05-11-2025+21_11", "TL2_05-11-2025+21_38", "TL3_05-11-2025+21_32", "TL4_05-11-2025+21_31", "TL5_05-11-2025+21_40", "TL6_05-11-2025+21_45", "TL7_05-11-2025+21_46"]
    # ["TransferLearned"]#["emnist_cnn_yang_big-pgd-training_21-10-2025+13_06"]#,
    job_configs = []

    for architecture in architectures:
        config = SlurmJobConfig(
            job_name=f"robustness_distributions_CNNYangBig",# {network.lower()}",
            script_path="MNISTRobustnessDistributions.py",
            partition="gpu-short", # gpu-short;gpu-2080ti-11g; gpu-mig-40g; gpu-a100-80g; gpu-l4-24g
            time_limit="00:10:00"
        )
        args = f"--directory_path ../CNNYangBig/{architecture}"
